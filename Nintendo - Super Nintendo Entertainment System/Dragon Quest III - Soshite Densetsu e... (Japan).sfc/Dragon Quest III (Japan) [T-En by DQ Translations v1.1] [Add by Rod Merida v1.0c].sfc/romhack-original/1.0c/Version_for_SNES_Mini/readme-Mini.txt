...
This version of the patch has been adapted to be compatible with the SNES Mini (with its default emulator, Canoe). Don't forget to set the "Extra byte" parameter to 03 when adding this game to the console.
v.1.0c

Bug fixes made by
(c) Rod Mérida, 25-XII-2021
Betatest by NeonZoux.
SNES Mini betatest by Stephen Cope.
Adjustment of this patch to LoROM, for its playability on SNES Mini,
  by Rod Mérida, 20-X-2022.
...
with a bps patching application, like Beat https://crackowia.com/utils/beat.php .

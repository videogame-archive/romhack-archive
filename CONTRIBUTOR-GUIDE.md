...
| **Colorization**         | Major, Cosmetic, Enhance<br />(*colorize only*)    | Adds colors to a game with monochrome or grayscale graphics.<br />*Examples: "Super Mario Land DX", "Donkey Kong Land: New Colors Mode"*                                                                                                                                                                                                              |
...
| **Cheat**                | Minor, Gameplay, Change<br />(*difficulty-*)       | Removes one or more aspects of the challenge.<br />*Examples: infinite lives, stage select, other common "trainer" or Game Genie effects*                                                                                                                                                                                                             |
| **EasyType**             | Minor, Gameplay, Change<br />(*difficulty-*)       | Reduces the difficulty (without removing it like Cheat).<br />*Examples: start with more lives, take less damage, removed level obstacles*                                                                                                                                                                                                            |
| **HardType**             | Minor, Gameplay, Change<br />(*difficulty+*)       | Increases the difficulty.<br />*Examples: start with less lives, take more damage, added level obstacles*                                                                                                                                                                                                                                             |
...
| **Performance**          | Minor, Gameplay, Enhance<br />(*performance only*) | Improves the overall performance of the game.<br />*Examples: lag reduction, shorter transitions, SNES SA-1 hacks*                                                                                                                                                                                                                                    |
...
| **Recolor**              | Minor, Cosmetic, Enhance                           | Improved color palettes intended as a touchup to the original experience.<br />*Examples: enhanced color hacks*                                                                                                                                                                                                                                       |
